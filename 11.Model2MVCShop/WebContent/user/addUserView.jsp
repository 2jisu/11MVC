			...
			$.ajax( 
					{
						...
						success : function(JSONData , status) {
							...
							if(JSONData){
								...
								$("#danger").html("사용할 수 있는 ID입니다.")
							}
							
							if(!JSONData){
								//alert("이미 존재하는 ID입니다.")
								$("input[name='userId']").css("background-color","orange")
								$("#danger").html("이미 존재하는 ID입니다.")
							}
						}							
	...
	<div class="container">
		...
		<form class="form-horizontal">
		  ...
		  <div class="form-group">
		    ...
		    <div class="col-sm-4">
		      <input type="text" class="form-control" id="userId" name="userId" placeholder="중복확인하세요" oninput="CheckDuplication()">
		       <span id="helpBlock" class="help-block">
		      	<!-- <strong class="text-danger" id="danger">입력전 중복확인 부터..</strong> -->
		      	<strong class="text-danger" id="danger">입력전 중복확인 부터..</strong>
		      </span>
		    </div>
		    <!-- <div class="col-sm-3">
