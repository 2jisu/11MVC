	...
	<div class="container">
		...
		<div class="form-group">
		  ...
		  <%-- <div class="form-group">
		    ...
		    <div class="col-sm-4">
		      <input type="text" class="form-control" id="manuDate" readonly="readonly" name="manuDate" value="${product.manuDate}">
		    </div>
		  </div> --%>
		  ...
		  <div class="form-group">
		    ...
		    <div class="col-sm-4">
		      <input type="text" class="form-control" id="price" name="price" value="${product.price}원" readonly>
		    </div>
		  </div>
